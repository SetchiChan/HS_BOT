    ...
    switch (args[0].toLowerCase()) {
        ...
        case "verify":
            if (message.member.roles.find("name", "Verified✔️")) {
                message.channel.sendMessage(member + ",you seem to be already verified. If you'd like to change your prefered lane roles, do 'pref. If you'd like to update your current rank, do 'Rankupdate. If you believe an error has occured, please contact <@&399009797921308674> to help you.");
            } else {
